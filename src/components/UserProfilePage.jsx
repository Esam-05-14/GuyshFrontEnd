...
export default function UserProfilePage() {
  ...
  return (
    <div className="min-h-screen bg-[#193042] text-white flex justify-center items-center p-8">
      <div className="bg-[#1c1c1c] rounded-2xl shadow-lg p-8 w-full max-w-3xl border border-gray-700">
