...
export default function MyProfile() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setMessage(t("myProfile.updateFail"));
    } finally {
      setLoading(false);
    }
  };
