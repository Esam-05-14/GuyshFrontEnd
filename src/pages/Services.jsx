  ...
  return (
    <div className='bg-[#D9D9D9] flex flex-col items-center justify-center w-full'>
      ...
      <div className='w-full px-20 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10 mt-5 mb-10 justify-items-center'>
        <ServiceCard name="Service 1" description="This is a description of service 1." />
        <ServiceCard name="Service 2" description="This is a description of service 2." />
        <ServiceCard name="Service 3" description="This is a description of service 3." />
        <ServiceCard name="Service 1" description="This is a description of service 1." />
        <ServiceCard name="Service 2" description="This is a description of service 2." />
        <ServiceCard name="Service 3" description="This is a description of service 3." />
      </div>
